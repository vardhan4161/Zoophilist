...
import {
  ...
  FadeInUp, SlideInLeft, SlideInRight, AnimatedCounter, SectionLabel
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex gap-4 shrink-0">
                  {[
                    { num: 500, suffix: "+", label: "Happy Pets" },
                    { num: 4.9, suffix: "★", label: "Rating" },
                  ].map((s) => (
                    <div key={s.label} className="glass-dark rounded-2xl p-4 text-center min-w-[90px] border border-white/10">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <SlideInRight>
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: 500, suffix: "+", label: "Happy Pets", color: "from-primary/20 to-accent/10" },
                { value: 3, suffix: "+", label: "Cities Served", color: "from-blue-500/20 to-cyan-500/10" },
                { value: 10, suffix: "+", label: "Expert Groomers", color: "from-violet-500/20 to-purple-500/10" },
                { value: 98, suffix: "%", label: "Satisfaction Rate", color: "from-amber-500/20 to-orange-500/10" },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
