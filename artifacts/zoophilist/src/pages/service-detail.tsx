...
import { CheckCircle2, ArrowRight, ArrowLeft, Clock, Shield, Sparkles } from "lucide-react";
            ...
            <SlideInRight>
              <div className="sticky top-24 space-y-5">
                ...
                <div className="glass-card rounded-2xl p-6">
                  <h4 className="font-bold text-white mb-4 text-sm">Included with your visit</h4>
                  <div className="space-y-3">
                    {[
                      { icon: Shield, text: "Doorstep service in a familiar setting" },
                      { icon: Sparkles, text: "Comfort-led handling for your pet" },
                      { icon: CheckCircle2, text: "Mobile setup brought to your location" },
                    ].map((item, i) => (
